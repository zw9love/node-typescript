...
import Service from '../service/BeeneedleSafeConfigAudit'
export default class BeeneedleSafeConfigAudit {
     ...
     * @param next 向下执行方法
     */
    clearAll(response: response, next: Function): void {
        this.service.clearAll(json => {
            response.json(json)
        }, next)
    }
